...
async function handleRequest(request, env, ctx) {
    ...
    if (url.pathname === '/' || url.pathname === '/index.html') {
      ...
      // 1) لو فيه عنصر في الشريط المتحرك مرتبط بنفس المنتج وليه صورة، تتستخدم هي (نفس الصورة المستخدمة للعرض والمشاركة معًا)
      // 2) لو مفيش، يرجع يستخدم صورة المنتج الرئيسية (نفس الصورة المعروضة في كارت المنتج، بدون حقل مشاركة منفصل)
      ...
      const imageToUse = product ? (carouselImageForProduct || product.mainImg) : siteShareImage;
